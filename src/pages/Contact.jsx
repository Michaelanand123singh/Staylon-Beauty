    ...
    <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl shadow-xl p-8 text-white">
          <div className="h-full flex flex-col justify-between">
            <div>
              <h2 className="text-2xl font-bold mb-6">Visit Staylon Beauty</h2>
              <p className="text-indigo-100 mb-8">
                Experience premium beauty services in a luxurious environment. Visit us today or contact us to book your appointment.
              </p>
              ...
              <ul className="space-y-6">
                ...
                <li className="flex items-center">
                  ...
                  <span className="ml-3 text-indigo-100">+91 8271491393</span>
                </li>
                <li className="flex items-center">
                  <Mail className="h-6 w-6 flex-shrink-0" />
                  <span className="ml-3 text-indigo-100">staylonbeauty@gmail.com</span>
                </li>
              </ul>
            </div>
      ...
      <div className="mt-16 bg-gray-100 rounded-2xl p-8">
        ...
        <div className="w-full rounded-xl overflow-hidden shadow-lg">
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29232.442437607657!2d86.1108125203973!3d23.673980137449444!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4224c00000001%3A0x41747cce54aa8af4!2sSTAYLON%20BEAUTY%20AND%20SPA%20SALON!5e0!3m2!1sen!2sin!4v1745731277277!5m2!1sen!2sin" 
            width="100%" 
            height="450" 
            style={{ border: 0 }} 
            allowFullScreen="" 
            ...
            title="STAYLON BEAUTY AND SPA SALON location"
            className="w-full"
          ></iframe>
        </div>
      </div>
